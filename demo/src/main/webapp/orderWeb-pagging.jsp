                    ...
                    <div class="container">
                        ...
                        <table class="table table-light">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-danger btn-sm" href="cancel-order?id=<%=order.getOrderId()%>">Cancel</a></td>
                            </tr>
                            <%}
                            }
                            %>
                        ...
                        <c:if test="${sessionScope.currentPage != 1}">
                            <td><a href="show-order-paging?page=${sessionScope.currentPage - 1}">Previous</a></td>
                        </c:if>
                            ...
                            <tr>
                                <c:forEach begin="1" end="${sessionScope.noOfPages}" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <td><a href="show-order-paging?page=${i}">${i}</a></td>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </tr>
                        ...
                        <c:if test="${currentPage lt noOfPages}">
                            <td><a href="show-order-paging?page=${sessionScope.currentPage + 1}">Next</a></td>
                        </c:if>
                    </div>
                    <!-- Contact address -->
            ...
            <div class="modal-body">
                ...
                <form class="aa-login-form" action="">
                    ...
                    <div class="aa-register-now">
                        Don't have an account?<a href="../../../../../../Downloads/MarkUps-dailyShop/dailyShop/account.html">Register now!</a>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
