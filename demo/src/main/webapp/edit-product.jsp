...
<%
  ...
  if (user != null) {
    ...
    orderList = orderDao.userOrders(user.getId(), user);
  } else {
              ...
              <div class="row">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">                              
                  <div class="aa-product-view-slider">                                
                    <div id="demo-3" class="simpleLens-gallery-container">
...
<%--                  </div>--%>
  <div class="aa-myaccount-register">
    ...
    <form action="" method="post" class="aa-login-form">
      ...
      <input type="text" placeholder="${sessionScope.product.getName()}" name="productname" >
      <label>Category<span>*</span></label>
      <input type="text" placeholder="${sessionScope.product.getCategory()}" name="category">
      <label>Price<span>*</span></label>
      <input type="text" placeholder="${sessionScope.product.getPrice()}" name="price">
      <label>Image<span>*</span></label>
      <input type="text" placeholder="${sessionScope.product.getImage()}" name="image">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">                              
                          <div class="aa-product-view-slider">                                
                            <div class="simpleLens-gallery-container" id="demo-4">
                              <div class="simpleLens-container">
                                  <div class="simpleLens-big-image-container">
                                      <a class="simpleLens-lens-image" data-lens-image="img/view-slider/large/polo-shirt-1.png">
                                          <img src="img/man/${sessionScope.product.getImage()}" class="simpleLens-big-image">
                                      </a>
                                  </div>
                              </div>
                              <div class="simpleLens-thumbnails-container">
        ...
        <div class="col-md-12">
          <div class="aa-subscribe-area">
            ...
            <form action="" class="aa-subscribe-form">
              <input type="email" name="" id="6" placeholder="Enter your Email">
